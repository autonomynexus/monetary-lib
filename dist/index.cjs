...
*/
const decrement$1 = (value) => value.minus(new big_js.default(1));
...
*/
const increment$1 = (value) => value.plus(new big_js.default(1));
...
*/
const integerDivide$1 = (dividend, divisor) => dividend.div(divisor).round(0, big_js.default.roundDown);
...
exports.bigintCalculator = calculator
exports.bigjsCalculator = calculator$1
exports.compare = compare
exports.convert = convert
exports.createMonetary = createMonetary
exports.down = down
exports.equal = equal
...
exports.numberCalculator = calculator$2
