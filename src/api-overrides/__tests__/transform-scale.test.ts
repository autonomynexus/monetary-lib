...
import { MGA, USD } from "@/currencies/iso4217/amendments/168";
...
describe("transformScale", () => {
  describe("number", () => {
    ...
    describe("decimal currencies", () => {
      it("returns a new Monetary object with a new scale and a converted amount", () => {
        const d = monetary({ amount: 500, currency: USD, scale: 2 });
        const snapshot = toSnapshot(transformScale(d, 4));

        expect(snapshot).toMatchObject({ amount: 50_000, scale: 4 });
      });
      it("returns a new Monetary object with a new scale and a converted, rounded down amount", () => {
        const d = monetary({ amount: 14_270, currency: USD, scale: 2 });
      ...
      it("converts between scales correctly", () => {
        const d = monetary({ amount: 333_336, currency: USD, scale: 5 });
      ...
      it("converts from long initial scales correctly", () => {
        const d = monetary({ amount: 3_333_333_336, currency: USD, scale: 9 });
        const snapshot = toSnapshot(transformScale(d, 2));

        expect(snapshot).toMatchObject({ amount: 333, scale: 2 });
      });
      it("uses the provided `up` divide function", () => {
        const d = monetary({ amount: 10_455, currency: USD, scale: 3 });
      ...
      it("uses the provided `halfOdd` divide function", () => {
        const d1 = monetary({ amount: 10_415, currency: USD, scale: 3 });
        const d2 = monetary({ amount: 10_425, currency: USD, scale: 3 });
      ...
      it("uses the provided `halfEven` divide function", () => {
        const d1 = monetary({ amount: 10_425, currency: USD, scale: 3 });
        const d2 = monetary({ amount: 10_435, currency: USD, scale: 3 });
      ...
      it("uses the provided `halfDown` divide function", () => {
        const d1 = monetary({ amount: 10_455, currency: USD, scale: 3 });
        const d2 = monetary({ amount: 10_456, currency: USD, scale: 3 });
      ...
      it("uses the provided `halfUp` divide function", () => {
        const d1 = monetary({ amount: 10_454, currency: USD, scale: 3 });
        const d2 = monetary({ amount: 10_455, currency: USD, scale: 3 });
    ...
    describe("non-decimal currencies", () => {
      ...
      it("uses the provided `halfOdd` divide function", () => {
        const d1 = monetary({ amount: 33, currency: ABC, scale: 2 });
        const d2 = monetary({ amount: 39, currency: ABC, scale: 2 });
  ...
  describe("bigint", () => {
    ...
    describe("decimal currencies", () => {
      ...
      it("uses the provided `up` divide function", () => {
        const d = monetary({ amount: 10455n, currency: bigintUSD, scale: 3n });
      ...
      it("uses the provided `halfOdd` divide function", () => {
        const d1 = monetary({ amount: 10415n, currency: bigintUSD, scale: 3n });
        const d2 = monetary({ amount: 10425n, currency: bigintUSD, scale: 3n });
      ...
      it("uses the provided `halfEven` divide function", () => {
        const d1 = monetary({ amount: 10425n, currency: bigintUSD, scale: 3n });
        const d2 = monetary({ amount: 10435n, currency: bigintUSD, scale: 3n });
      ...
      it("uses the provided `halfDown` divide function", () => {
        const d1 = monetary({ amount: 10455n, currency: bigintUSD, scale: 3n });
        const d2 = monetary({ amount: 10456n, currency: bigintUSD, scale: 3n });
      ...
      it("uses the provided `halfUp` divide function", () => {
        const d1 = monetary({ amount: 10454n, currency: bigintUSD, scale: 3n });
        const d2 = monetary({ amount: 10455n, currency: bigintUSD, scale: 3n });
    ...
    describe("non-decimal currencies", () => {
      it("returns a new Monetary object with a new scale and a converted amount", () => {
        const d = monetary({ amount: 5n, currency: bigintMGA });
        const snapshot = toSnapshot(transformScale(d, 2n));

        expect(snapshot).toMatchObject({ amount: 25n, scale: 2n });
      });
      it("returns a new Monetary object with a new scale and a converted, rounded down amount", () => {
        const d = monetary({ amount: 26n, currency: bigintMGA, scale: 2n });
        const snapshot = toSnapshot(transformScale(d, 1n));

        expect(snapshot).toMatchObject({ amount: 5n, scale: 1n });
      });
      it("uses the provided `up` divide function", () => {
        const d = monetary({ amount: 33n, currency: bigintABC, scale: 2n });
      ...
      it("uses the provided `halfOdd` divide function", () => {
        const d1 = monetary({ amount: 33n, currency: bigintABC, scale: 2n });
        const d2 = monetary({ amount: 39n, currency: bigintABC, scale: 2n });
  ...
  describe("Big.js", () => {
    ...
    describe("decimal currencies", () => {
      it("returns a new Monetary object with a new scale and a converted amount", () => {
        ...
        expect(snapshot).toMatchObject({
          amount: new Big(50_000),
          scale: new Big(4),
        });
      });
      it("returns a new Monetary object with a new scale and a converted, rounded down amount", () => {
        const d = monetary({
          amount: new Big(14_270),
          currency: bigjsUSD,
          scale: new Big(2),
        });
      ...
      it("uses the provided `halfOdd` divide function", () => {
        const d1 = monetary({
          amount: new Big(10_415),
          currency: bigjsUSD,
          scale: new Big(3),
        });
        const d2 = monetary({
          amount: new Big(10_425),
          currency: bigjsUSD,
          scale: new Big(3),
        });
    ...
    describe("non-decimal currencies", () => {
      it("returns a new Monetary object with a new scale and a converted amount", () => {
        const d = monetary({ amount: new Big(5), currency: bigjsMGA });
        const snapshot = toSnapshot(transformScale(d, new Big(2)));
