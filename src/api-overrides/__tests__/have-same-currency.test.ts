...
describe("haveSameCurrency", () => {
  describe("number", () => {
    ...
    it("returns true when currencies are equal", () => {
      const d1 = monetary({ amount: 2000, currency: USD });
    ...
    it("returns false when currencies are not equal", () => {
      ...
      const d2 = monetary({ amount: 1000, currency: EUR });
    ...
    it("returns true when multi-base currencies are structurally equal", () => {
      ...
      const d1 = monetary({ amount: 240, currency: GBP });
      const d2 = monetary({ amount: 240, currency: GBP });
  ...
  describe("bigint", () => {
    ...
    it("returns true when currencies are equal", () => {
      const d1 = monetary({ amount: 2000n, currency: bigintUSD });
    ...
    it("returns false when currencies are not equal", () => {
      ...
      const d2 = monetary({ amount: 1000n, currency: bigintEUR });
    ...
    it("returns true when multi-base currencies are structurally equal", () => {
      ...
      const d1 = monetary({ amount: 240n, currency: GBP });
      const d2 = monetary({ amount: 240n, currency: GBP });
  ...
  describe("Big.js", () => {
    ...
    it("returns true when currencies are equal", () => {
      const d1 = monetary({ amount: new Big(2000), currency: bigjsUSD });
    ...
    it("returns false when currencies are not equal", () => {
      ...
      const d2 = monetary({ amount: new Big(1000), currency: bigjsEUR });
    ...
    it("returns true when multi-base currencies are structurally equal", () => {
      ...
      const d1 = monetary({ amount: new Big(240), currency: GBP });
      const d2 = monetary({ amount: new Big(240), currency: GBP });
