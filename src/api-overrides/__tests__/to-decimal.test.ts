...
describe("toDecimal", () => {
  describe("number", () => {
    ...
    describe("decimal currencies", () => {
      ...
      it("returns the negative amount with a leading zero in decimal format", () => {
        const d = monetary({ amount: -1, currency: USD });
    ...
    describe("non-decimal currencies", () => {
      it("throws when passing a Monetary object using a non-decimal currency", () => {
        const d = monetary({ amount: 13, currency: MGA });

        expect(() => {
          toDecimal(d);
        }).toThrowErrorMatchingInlineSnapshot(
          "[Error: [Monetary] Currency is not decimal.]"
        );
      });
      it("throws when passing a Monetary object using a multi-base currency which compiles to a multiple of 10", () => {
        const d = monetary({
          amount: 13,
  ...
  describe("bigint", () => {
    ...
    describe("decimal currencies", () => {
      it("returns the amount in decimal format", () => {
        const d = monetary({ amount: 1050n, currency: bigintUSD });
      ...
      it("returns the amount in decimal format based on a custom scale", () => {
        const d = monetary({ amount: 10545n, currency: bigintUSD, scale: 3n });

        expect(toDecimal(d)).toEqual("10.545");
      });
      it("returns the amount in decimal format with trailing zeros", () => {
        const d = monetary({ amount: 1000n, currency: bigintUSD });

        expect(toDecimal(d)).toBe("10.00");
      });
      it("returns the amount in decimal format with leading zeros", () => {
        const d = monetary({ amount: 1005n, currency: bigintUSD });
      ...
      it("returns the negative amount with a leading zero in decimal format", () => {
        const d = monetary({ amount: -1n, currency: bigintUSD });
    ...
    describe("non-decimal currencies", () => {
      it("throws when passing a Monetary object using a non-decimal currency", () => {
        const d = monetary({ amount: 13n, currency: bigintMGA });
  ...
  describe("Big.js", () => {
    ...
    describe("decimal currencies", () => {
      it("returns the amount in decimal format", () => {
        const d = monetary({ amount: new Big(1050), currency: bigjsUSD });
      ...
      it("returns the amount in decimal format with trailing zeros", () => {
        const d = monetary({ amount: new Big(1000), currency: bigjsUSD });

        expect(toDecimal(d)).toBe("10.00");
      });
      it("returns the amount in decimal format with leading zeros", () => {
        const d = monetary({ amount: new Big(1005), currency: bigjsUSD });
      ...
      it("returns the negative amount with a leading zero in decimal format", () => {
        const d = monetary({ amount: new Big(-1), currency: bigjsUSD });
    ...
    describe("non-decimal currencies", () => {
      it("throws when passing a Monetary object using a non-decimal currency", () => {
        const d = monetary({ amount: new Big(13), currency: bigjsMGA });
